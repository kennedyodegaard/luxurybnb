...
flat1 = Flat.new(title: "Louis' Mansion", description: "A very expensive place", location: "Barcelona", price: 36000, user: user1)
...
flat2 = Flat.new(title: "Jie's Retreat", description: "A very beautiful place", location: "Madrid", price: 300, user: user1)
...
flat3 = Flat.new(title: "Sefi's Villa", description: "A very tranquil place", location: "Valencia", price: 250, user: user1)
